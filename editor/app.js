...
window.addEventListener('keydown', (e) => {
  ...
  switch (e.code) {
    case 'KeyC': setTool('select'); break;
...
function updateHint() {
  const h = {
    select: '<b>Click</b> a shape to select it · <b>Shift+click</b> more · <b>1 / 2 / 3</b> move / rotate / resize · <b>R</b> turn · <b>G</b> hollow · <b>Del</b> remove · <b>Ctrl+Z</b> undo · <b>P</b> play',
